...
#ifndef LIBHYPNOQUARTZ_PAINT_INC_IANIMATORCALLBACK_H_
#define LIBHYPNOQUARTZ_PAINT_INC_IANIMATORCALLBACK_H_
 ...
 * Virtual class defining an interface to be used for animation
 */
class IAnimatorCallback {
public:
	IAnimatorCallback() {}
...
#endif /* LIBHYPNOQUARTZ_PAINT_INC_IANIMATORCALLBACK_H_ */
