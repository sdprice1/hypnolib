...
#ifndef LIBHYPNOQUARTZ_MODEL_INC_MODEL_H_
#define LIBHYPNOQUARTZ_MODEL_INC_MODEL_H_
...
public:
	...
	/**
	 * Set the pixle at the specified coords to the specified colour. Return true if all ok
	 *
...
protected:
	...
	bool checkCoord(const Coord& coord) ;
...
#endif /* LIBHYPNOQUARTZ_MODEL_INC_MODEL_H_ */
